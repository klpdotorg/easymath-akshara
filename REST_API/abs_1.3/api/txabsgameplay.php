...
/**
 * Service API:  txabsgameplay
 * Purpose: Sync the 'gameplay' data to the ABS 
 * File name: txabsgameplay.php
 ...
 */
    ...
    if(count($jsondata_array,1) == 0) {
        ...
        $em = new exceptionMgr(" ");
        $em->logInfo("txabsgameplay: Error: Received no input JSON data."); 
    }
    else {
        ...
        foreach($jsondata_array as $data) {
            ...
            if($data) {
                ...
                if(($access_token == null) || ($access_token == '')) {
                    ...
                    $em = new exceptionMgr(" ");
                    $em->logInfo("txabsgameplay: Error: access token is missing."); 
                }
                else {
                    ...
                    if(!$tokenvalid) {
                        ...
                        $em = new exceptionMgr(" ");
                        $em->logInfo("txabsgameplay: Error: Invalid access token."); 
                    }
                    else {
                        ...
                        $objGameplay->setAccessToken($access_token);
                        ...
                        if($rtn) {
                            ...
                            $em = new exceptionMgr(" ");
                            $em->logInfo("txabsgameplay: Error: Failed to save Gameplay Data."); 
                        }
                    }
                }
            }
                ...
                $em = new exceptionMgr(" ");
                $em->logInfo("txabsgameplay: Error: Data missing for this JSON object."); 
             }
