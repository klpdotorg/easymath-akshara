 ...
 */
    ...
    if(count($jsondata_array,1) == 0) {
        ...
        $em = new exceptionMgr(" ");
        $em->logInfo("txekstepevents: Error: Received no input JSON data."); 
    }
    else {
        ...
        foreach($jsondata_array as $data) {
            ...
            if($data) {
                ...
                if(($access_token == null) || ($access_token == '')) {
                    ...
                    $em = new exceptionMgr(" ");
                    $em->logInfo("txekstepevents: Error: access token is missing."); 
                }
                else if(!$edata) {
                    ...
                    $em = new exceptionMgr(" ");
                    $em->logInfo("txekstepevents: Error: JSON event object has empty 'edata{}'."); 
                }
                    ...
                    $em = new exceptionMgr(" ");
                    $em->logInfo("txekstepevents: Error: JSON event object has empty 'eks{}'."); 
                }
                else {
                    ...
                    if(!$tokenvalid) {
                        ...
                        $em = new exceptionMgr(" ");
                        $em->logInfo("txekstepevents: Error: Invalid access token.");
                    }
                    else {
                        ...
                        $objEkStepEventData->setAccessToken($access_token);
                        ...
                        if($rtn) {
                            ...
                            $em = new exceptionMgr(" ");
                            $em->logInfo("txekstepevents: Error: Failed to save the EkStep Event Data.");
                        }
                    }
                }
            }
                ...
                $em = new exceptionMgr(" ");
                $em->logInfo("txekstepevents: Error: Data missing for this JSON event object.");
             }
