    ...
    if($data) {
        ...
        if(($access_token != null) || ($access_token != '')) {
           ...
           if(!$tokenvalid) {
               ...
               $em = new exceptionMgr(" ");
               $em->logInfo("updateavatarpic: Error: Invalid access token: ".$access_token);
           }
           else {
               ...
               if(!$childid) {
                   ...
                   $em = new exceptionMgr(" ");
                   $em->logInfo("updateavatarpic: Error: Failed to retrieve the Child details for the given access token ($access_token).");
               }
